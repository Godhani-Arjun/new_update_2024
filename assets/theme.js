...
onFormVisibilityChange_fn = function(entries) {
  ...
  // Update the condition here to keep the sticky bar open when the footer is visible
  this.classList.toggle("is-visible", __privateGet(this, _latestFormCondition) || __privateGet(this, _latestFooterCondition));
};
